...
class TotalBooks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.total_books)
        ...
        myRef.addValueEventListener(object:ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if(p0.exists()){
                    ...
                    val adapter=AddNewBooksAdapter(this@TotalBooks, R.layout.add_new_book_model,bookList)
